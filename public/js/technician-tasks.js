document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadTechnicianTasks() {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/technician/tickets?page=1&per_page=15`, {
                method: 'GET',
                headers: {
    ...
    window.confirmTicket = async function (ticketId, ticketNumber) {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/tickets/${ticketId}/confirm`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    window.rejectTicket = async function (ticketId, ticketNumber) {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/tickets/${ticketId}/reject`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    document.getElementById('updateForm').addEventListener('submit', async function (e) {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/tickets/${ticketId}/solve`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
