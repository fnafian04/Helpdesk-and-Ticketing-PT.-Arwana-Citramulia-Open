document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadHistory() {
        ...
        tbody.innerHTML = '<tr><td colspan="6" class="loading-spinner"><i class="fa-solid fa-spinner fa-spin"></i> Memuat data...</td></tr>';
    ...
    function renderHistory(tickets) {
        ...
        tbody.innerHTML = tickets.map(ticket => {
            ...
            const badgeClass = statusName.toLowerCase() === 'closed' ? 'badge-closed' : 'badge-resolved';
